...
from envs.quadrotor_payload_env_v2 import QuadrotorPayloadEnv
...
def parse_arguments():
    ...
    parser.add_argument('--checkpoint', type=str, default=None, help='Load a pretrained model ID from runs/v2_1/<id>/checkpoints.')
...
def main():
    ...
    run_paths = get_run_directories("v2_1", experiment_id)
    ...
    if args_dict['checkpoint'] is not None:
        path = get_checkpoint_path("v2_1", args_dict['checkpoint'])
